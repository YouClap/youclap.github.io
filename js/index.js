...
var colorPicker = (function() {
  var colors = ["#52bcb8", "#4a85c5", "#e73a35", "#282741"];
  var index = 0;
  function next() {
...
function addClickListeners() {
  document.getElementById("buttonclap").addEventListener("touchstart", handleEvent);
  document.getElementById("buttonclap").addEventListener("mousedown", handleEvent);
};
